module.exports = {
  ...
  ignorePatterns: ['dist', 'build', '.eslintrc.cjs', 'tailwind.config.cjs'],
  globals: {
    __dirname: true,
    JSX: true,
  },
  rules: {
    ...
    //
    indent: [1, 2, { SwitchCase: 1, ObjectExpression: 1 }], // this option sets a specific tab width for your code (off by default)
    ...
    'no-plusplus': [1, { allowForLoopAfterthoughts: true }], // disallow use of unary operators, ++ and -- (off by default)
